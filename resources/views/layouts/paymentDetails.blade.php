...
@section('head')
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-VF9g..." crossorigin="anonymous" referrerpolicy="no-referrer" />
<style>
  body {
    background: #f9fafb;
...
<div class="mobile-card">
  ...
  <form method="POST" action="">
    ...
    <div class="btn-row">
      ...
      <a href="{{ route('payment.skip') }}" class="btn-action btn-secondary">
        <i class="fa-solid fa-forward"></i> Skip Payment
    </a>
